ruleset {
    ...
    'DuplicateNumberLiteral' doNotApplyToClassNames: 'AssetPipelineIncludeProcessor',  doNotApplyToFilesMatching: '.*Spec.groovy'
    ...
    'SpaceAroundMapEntryColon' characterBeforeColonRegex: /\S|\s+/, characterAfterColonRegex: /\s+/
    SpaceAroundOperator
    ...
    ParameterName
    'PropertyName' doNotApplyToClassNames: 'AsciidoctorAssetFile'
    VariableName
    ...
    // rulesets/unused.xml
    UnusedArray
    'UnusedMethodParameter' doNotApplyToClassNames: 'AsciidoctorAssetFile'
    UnusedObject
    UnusedPrivateField
    UnusedPrivateMethod
